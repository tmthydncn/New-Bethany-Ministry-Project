class ReportController < ApplicationController
  ...
  def food_visit
    if params[:start].nil?
      ...
      atStart = DateTime.civil(params[:start]["(1i)"].to_i,params[:start]["(2i)"].to_i,params[:start]["(3i)"].to_i, Rational(-6, 24))
      atEnd = DateTime.civil(params[:end]["(1i)"].to_i,params[:end]["(2i)"].to_i,params[:end]["(3i)"].to_i, Rational(-6, 24))
